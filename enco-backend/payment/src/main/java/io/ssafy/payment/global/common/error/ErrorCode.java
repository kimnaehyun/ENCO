...
public enum ErrorCode {
    ...
    POINT_SYSTEM_ERROR(HttpStatus.BAD_REQUEST, "Auth 서버에 포인트 조회/차감 오류가 발생했습니다.", "POINT_SYSTEM_ERROR"),
    NOT_GROUP_MEMBER(HttpStatus.NOT_FOUND, "현재 가입된 모임원이 아닙니다.", "NOT_GROUP_MEMBER"),
