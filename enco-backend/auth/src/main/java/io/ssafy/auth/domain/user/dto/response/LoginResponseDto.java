...
public record LoginResponseDto (Long id, String name, String email, String phoneNumber, String profileImg, String deviceToken, String accessToken, long expiresIn, String tokenType) {
