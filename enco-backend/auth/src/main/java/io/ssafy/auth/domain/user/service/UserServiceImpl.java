...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public UserJoinResponseDto signup(UserJoinRequestDto userRequest) throws Exception {
    ...
    @Override
    public LoginResponseDto login(String deviceToken, String pinCode) throws Exception {
    ...
    public boolean validateDuplicateEmail(String email){
        log.info("test" + userRepository.existsByEmail(email));
