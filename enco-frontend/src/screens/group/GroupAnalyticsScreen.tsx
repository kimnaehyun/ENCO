...
type GroupAnalyticsRouteProp = RouteProp<HomeStackParamList, 'GroupAnalytics'>;
type GroupAnalyticsNavigationProp = NativeStackNavigationProp<
  HomeStackParamList,
  'GroupAnalytics'
>;
...
export default function GroupAnalyticsScreen() {
  const navigation = useNavigation<GroupAnalyticsNavigationProp>();
  ...
  const fetchAll = useCallback(async () => {
    ...
    try {
      ...
      const spent = confirmedThisMonthItems.reduce(
      ...
      console.error(
        '[Analytics] transactions fetch failed:',
        (error as { response?: { data?: unknown } })?.response?.data,
      );
    ...
    <ScreenLayout>
      ...
      >
        ...
        <View style={styles.cardWrap}>
          <BudgetGaugeCard budget={monthlyBudget} spent={totalExpense} />
        </View>
