        ...
        <PinEntry
          ...
          footerContent={
            <Pressable onPress={() => setStep('email')}>
              <Text className="text-[#6B7280] text-sm underline">
                이메일 다시 입력
              </Text>
            </Pressable>
          }
  ...
  return (
    ...
    >
      <View className="flex-1 justify-center px-8">
        ...
        <Text className="text-sm mb-2 text-[#374151]">이메일</Text>
        <TextInput
        ...
        >
          <Text className="text-[#6B7280] text-sm underline">뒤로 가기</Text>
        </Pressable>
      </View>
    </KeyboardAvoidingView>
  );
